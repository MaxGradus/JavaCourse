 ...
 * 
 */
@WebServiceClient(name = "SayHelloServiceService", targetNamespace = "http://webservice.javacourse.ru/", wsdlLocation = "http://localhost:8080/sayHello/sayHello/SayHelloService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/sayHello/sayHello/SayHelloService?wsdl");
    ...
    public SayHello getSayHelloServicePort() {
        return super.getPort(new QName("http://webservice.javacourse.ru/", "SayHelloServicePort"), SayHello.class);
    }
     ...
     */
    @WebEndpoint(name = "SayHelloServicePort")
    public SayHello getSayHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.javacourse.ru/", "SayHelloServicePort"), SayHello.class, features);
    }
