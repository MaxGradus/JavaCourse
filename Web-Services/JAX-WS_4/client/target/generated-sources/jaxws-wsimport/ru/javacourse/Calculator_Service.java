 ...
 * 
 */
@WebServiceClient(name = "calculator", targetNamespace = "http://javacourse.ru", wsdlLocation = "http://localhost:8080/webservice/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://javacourse.ru", "calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservice/calculator?wsdl");
    ...
    public Calculator getCalculatorServicePort() {
        return super.getPort(new QName("http://javacourse.ru", "CalculatorServicePort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javacourse.ru", "CalculatorServicePort"), Calculator.class, features);
    }
